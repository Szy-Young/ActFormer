...
parser.add_argument('-d', '--data_path', default='datasets/ntu120_smpl/ntu_1p.h5')
parser.add_argument('-o', '--out_path', default='datasets/ntu120_smpl/data_1p')
arg = parser.parse_args()

selected_class = list(range(1, 50)) + list(range(61, 106)) # 1p
